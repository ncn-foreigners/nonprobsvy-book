...
This methods can provide robust results, but suffers from so called curse of dimensionanlity. For $p > 1$ asymptotic bias of the estimator is not negligible (Yang and Kim, 2020).
Variance of an estimator
